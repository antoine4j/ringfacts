    ...
    properties: {
      ...
      new_claim: {
        ...
        properties: {
          type: {
            type: "string",
            enum: ["announcement", "result", "injury", "quote", "prediction", "negotiation", "lifestyle", "other"],
          },
          canonical_text: {
            type: "string",
...
- WRONG_SUBJECT ONLY if the article is not about this fighter AT ALL: a namesake (e.g. an esports driver also named Fighter B), a relative (Fighter C's brother is Ilia's brother — a different fighter), or keyword-stuffed junk with no real connection. Judge on EVERYTHING shown: a body that clearly concerns ${fighter} overrides a headline that never names them.
...
- An article mainly about OTHER fighters or the division whose OWN TEXT mentions or peripherally involves ${fighter} (as a rival, comparison, or context) is NO_CLAIM — NOT WRONG_SUBJECT. Readers still see NO_CLAIM articles; WRONG_SUBJECT articles are dropped.
