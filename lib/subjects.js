...
// still open): Cyrillic aliases matter most for the subjects western media
// ignores. Each alias pairs with a Google News language edition.
// matchNames (2e) filter outlet-wide direct feeds down to this subject —
...
export const matchNamesOf = (name) =>
  SUBJECTS.find((f) => f.name === name)?.matchNames ?? [];
