// Digest tiering: is this article ABOUT the fighter, or does it merely sit
...
//
// Thresholds are MEASURED, not guessed (audit-digest-tier.js, 2026-08-09,
// over 60 archived items once backfill-bodies.js raised body coverage to
// 49/60): among items with a usable body, claim-bearing articles name the
// fighter 2-12x while the junk cluster names them 0-1x. Clean gap at 1|2,
// same shape as the 0.80 dup and 0.10 drift thresholds.
//
// Two alternatives were tested and REJECTED, so don't reintroduce them:
//   - name-in-headline alone: item #26 is a genuine Fighter B story headlined
...
// claim source whose headline never names the fighter and whose body — a
...
// Case-insensitive substring over the fighter's surname stems, both scripts.
